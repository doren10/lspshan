                ...
                <div class="card-body p-5">
                    <form action="/aspirasi/store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="id" class="form-control text-light fw-bold" readonly
                                value="{{ $no }}" style="background-color: #07133a;;">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Nomor Induk Siswa</label>
                            <input type="number" name="nis" value="{{ old('nis') }}"
                                class="form-control @error('nis') is-invalid @enderror text-light" style="background-color: #07133a;">
                            @error('nis')
                        ...
                        <div class="mb-3">
                            ...
                            <div class=" container row d-flex justify-content-center">
                                <div class="col-12 rounded-4 bg-gradient p-3 text-light fw-bold" style="background-color: #07133a;">
                                    <div class="row ">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="lokasi" value="{{ old('lokasi') }}"
                                class="form-control  @error('lokasi') is-invalid @enderror text-light" style="background-color: #07133a;">
                            @error('lokasi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3" >
                            ...
                            <textarea name="ket" id="" value="{{ old('ket') }}"
                                class="form-control @error('ket') is-invalid @enderror text-light" rows="2" style="background-color: #07133a;"></textarea>
                            @error('ket')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
...
<section id="aspirasi" class=" py-4 justify-content-center" style="height: 100vh;">
    <div class="row justify-content-center">
        <div class="col-12 mb-3">
            <nav class="navbar navbar-expand-lg shadow border-bottom rounded-4 p-lg-3 p-sm-0 p-md-3" style="background-color: #07133a;">
                <div class="container">
